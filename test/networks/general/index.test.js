...
(0, globals_1.describe)('generateAddresses', () => {
    ...
    (0, globals_1.test)('generateAddressesPrivateSolana', async () => {
        const addresses = (0, generate_address_1.generateAddresses)({ mnemonic, idCoin: 'solana' });
    ...
    (0, globals_1.test)('generateAddressesPrivateETH', async () => {
        const addresses = (0, generate_address_1.generateAddresses)({ mnemonic, idCoin: 'eth' });
