...
exports.wordlists =
    exports.getDefaultWordlist =
    exports.setDefaultWordlist =
...
function pbkdf2Promise(password, saltMixin, iterations, keylen, _digest) {
    const derivedKey = (0, pbkdf2_1.pbkdf2)(
        sha512_1.sha512,
        password,
        saltMixin,
        {
