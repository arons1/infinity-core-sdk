...
/**
 * StrKey is a helper class that allows encoding and decoding keys
...
export class StrKey {
   ...
   * @returns {Buffer}
   */
  static decodeEd25519SecretSeed(address:string) {
   ...
   * @returns {string}
   */
  static encodeMed25519PublicKey(data:Buffer) {
   ...
   * @returns {Buffer}
   */
  static decodeMed25519PublicKey(address:string) {
    return decodeCheck('med25519PublicKey', address);
  }

  /**
   * Returns true if the given  public key is a valid med25519 public key.
   * @param {string} publicKey public key to check
   * @returns {boolean}
   */
  static isValidMed25519PublicKey(publicKey:string) {
   ...
   * @returns {Buffer}
   */
  static decodePreAuthTx(address:string) {
   ...
   * @returns {Buffer}
   */
  static decodeSha256Hash(address:string) {
   ...
   * @returns {string}
   */
  static encodeSignedPayload(data:Buffer) {
   ...
   * @returns {Buffer}
   */
  static decodeSignedPayload(address:string) {
   ...
   * @returns {boolean}
   */
  static isValidSignedPayload(address:string) {
   ...
   * @returns {string}
   */
  static encodeContract(data:Buffer) {
   ...
   * @returns {Buffer}
   */
  static decodeContract(address:string) {
   ...
   * @returns {boolean}
   */
  static isValidContract(address:string) {
...
function calculateChecksum(payload:Uint8Array) {
  const crcTable = [
