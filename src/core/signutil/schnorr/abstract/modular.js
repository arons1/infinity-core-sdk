...
function Field(ORDER, bitLen, isLE = false, redef = {}) {
    ...
    const f = Object.freeze({
        ...
        toBytes: num =>
            isLE
                ? (0, utils_1.numberToBytesLE)(num, BYTES)
                : (0, utils_1.numberToBytesBE)(num, BYTES),
        fromBytes: bytes => {
            ...
            return isLE
                ? (0, utils_1.bytesToNumberLE)(bytes)
                : (0, utils_1.bytesToNumberBE)(bytes);
        },
    });
...
function hashToPrivateScalar(hash, groupOrder, isLE = false) {
    ...
    const num = isLE
        ? (0, utils_1.bytesToNumberLE)(hash)
        : (0, utils_1.bytesToNumberBE)(hash);
