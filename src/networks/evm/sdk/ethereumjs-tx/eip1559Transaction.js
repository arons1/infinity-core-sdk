...
class FeeMarketEIP1559Transaction extends baseTransaction_1.BaseTransaction {
    ...
    constructor(txData) {
        ...
        const { chainId, accessList, maxFeePerGas, maxPriorityFeePerGas } =
            txData;
        ...
        this.maxFeePerGas = new core_1.BN(
            (0, ethereumjs_util_1.toBuffer)(
                maxFeePerGas === '' ? '0x' : maxFeePerGas,
            ),
        );
        this.maxPriorityFeePerGas = new core_1.BN(
            (0, ethereumjs_util_1.toBuffer)(
        ...
        if (
            this.gasLimit
                .mul(this.maxFeePerGas)
                .gt(ethereumjs_util_1.MAX_INTEGER)
        ) {
    ...
    raw() {
        return [
            ...
            (0, ethereumjs_util_1.bnToUnpaddedBuffer)(
    ...
    toJSON() {
        ...
        return {
            ...
            maxPriorityFeePerGas: (0, ethereumjs_util_1.bnToHex)(
                this.maxPriorityFeePerGas,
            ),
